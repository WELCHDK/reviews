...
$("#reviewButton").on("click", function () {
  ...
  $("#str4").on("click", function () {
    console.log("User rating: four stars");
    rateReset();
    colorReset();
  ...
  $("#str5").on("click", function () {
    console.log("User rating: five stars");
    rateReset();
    colorReset();
...
// }
  /*else if($("#chatinput").val() == "") {
      $(".star").css("filter", "blur(1.5px)");
      $("#str1, #str2, #str3, #str4, #str5").attr("disabled", true);
    }*/
});
...
/*$("#newReview").on("click", function(){
  $("#reviewPanel::-webkit-scrollbar-thumb").css("background", "green");
});*/